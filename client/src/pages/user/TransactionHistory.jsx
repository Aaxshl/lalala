                  ...
                  >
                    ...
                    <td style={{ color: theme.text.primary }} className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-semibold">{tx.type === 'credit' ? 'Cash-In' : tx.description || 'Purchase'}</div>
                          {tx.merchant?.name && (
                    ...
                    <td className="p-4">
                      <span style={{
                        ...
                        {tx.type === 'credit' ? 'Cash-In' : 'Purchase'}
                      </span>
                    </td>
                    <td className="p-4 text-right">
                      <span style={{ color: tx.type === 'credit' ? '#10B981' : '#EF4444' }} className="font-bold text-base">
                        {tx.type === 'credit' ? '+' : '-'}₱{Math.abs(tx.amount || 0).toLocaleString('en-PH', { minimumFractionDigits: 2 })}
                      </span>
                    </td>
      ...
      {selectedTransaction && (
        ...
        >
          ...
          >
            {/* Header */}
            <div style={{
              background: selectedTransaction.type === 'credit' ? 'rgba(16,185,129,0.2)' : 'rgba(239,68,68,0.2)'
            }} className="p-6 text-center">
              <div className="text-4xl mb-2">
                {selectedTransaction.type === 'credit' ? '💵' : '🛒'}
              </div>
              <p style={{ color: selectedTransaction.type === 'credit' ? '#10B981' : '#EF4444' }} className="font-bold text-3xl">
                {selectedTransaction.type === 'credit' ? '+' : '-'}₱{Math.abs(selectedTransaction.amount || 0).toLocaleString('en-PH', { minimumFractionDigits: 2 })}
              </p>
              <p style={{ color: theme.text.secondary }} className="text-sm mt-1 capitalize">
                {selectedTransaction.type === 'credit' ? 'Cash-In' : 'Purchase'}
              </p>
            </div>
