              ...
              {transactions.map((tx, idx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p style={{ color: theme.text.primary }} className="font-semibold text-sm">
                        {tx.type === 'credit' ? 'Cash-In' : tx.description || 'Purchase'}
                      </p>
                  ...
                  <div className="text-right">
                    <p style={{ color: tx.type === 'credit' ? '#10B981' : '#EF4444' }} className="font-bold text-sm">
                      {tx.type === 'credit' ? '+' : '-'}P{Math.abs(tx.amount || 0).toLocaleString('en-PH', { minimumFractionDigits: 2 })}
                    </p>
                  </div>
                </div>
              ))}
